$(document).ready(function () {
    ...
    function populatePortfolio() {
        ...
        var projcard1 = $("<div class='col s12 m6 l4'><div class='card medium'><div class='card-image'><img src='assets/images/gifwebpagethumbnail.jpg'><span style='font-size:1.40em;padding:10px;' class='card-title white-text red'>Giftastic Web App</span></div><div class='card-content'><p class='card-textcontent'>A web page using the GIPHY API to generate button categories which then generate gifs</p></div><div class='card-action'><a class='red-text' href='https://nrvpatel03.github.io/Giftastic-webpage/' target='_blank'>View Project</a></div></div></div>");
        var projcard2 = $("<div class='col s12 m6 l4'><div class='card medium'><div class='card-image'><img src='assets/images/triviaquestiongamethumbnail.jpg'><span style='font-size:1.40em;padding:10px;' class='card-title white-text red'>Trivia Question Game</span></div><div class='card-content'><p class='card-textcontent'>A timed true and false trivia question game created using JavaScript timeout functions</p></div><div class='card-action'><a class='red-text' href='https://nrvpatel03.github.io/trivia-question-game/' target='_blank'>View Project</a></div></div></div>");
        var projcard3 = $("<div class='col s12 m6 l4'><div class='card medium'><div class='card-image'><img src='assets/images/time4colorboxthumbnail.jpg'><span style='font-size:1.40em;padding:10px;' class='card-title white-text red'>Time4ColorBox Mobile App Game</span></div><div class='card-content'><p class='card-textcontent'>A mobile application timed game created using Android Studio and Java programming</p></div><div class='card-action'><a class='red-text' href='https://play.google.com/store/apps/details?id=com.appsbyn.time4colorbox&hl=en_US' target='_blank'>View Project</a></div></div></div>");
