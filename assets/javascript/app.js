$(document).ready(function () {
    ...
    function populatePortfolio() {
        ...
        var projcard4 = $("<div class='col s12 m6 l4'><div class='card medium'><div class='card-image'><img src='assets/images/cookieFinderPic.JPG'><span style='font-size:1.40em;' class='card-title white-text red'>Cookie Finder App</span></div><div class='card-content'><p class='card-textcontent'>A web application finding nearest cookie vendors using the Google Maps API. Allows for signup for vendors and online purchasing for customers</p></div><a style='font-size:1.40em;padding:10px;' class='red-text' href='https://cookie-seller-app.herokuapp.com/' target='_blank'>View Project</a></div></div>");

        var cardrow = $("<div class='row'></div>");
        cardrow.append(projcard1).append(projcard2).append(projcard3).append(projcard4);
