$(document).ready(function () {
    ...
    function populatePortfolio() {
        ...
        var projcard1 = $("<div class='col s12 m6 l4'><div class='card medium'><div class='card-image'><img src='assets/images/beerpeerspic.jpg'><span style='font-size:1.40em;' class='card-title white-text red'>Beer Peers</span></div><div class='card-content'><p class='card-textcontent'>A social media website, developed using React, for craft beer brewers to share their recipes.</p></div><a style='font-size:1.40em;padding:10px;' class='red-text' href='https://www.beerpeersapp.com' target='_blank'>View Project</a><p style='font-size:1.40em;margin-top: 15px; margin-bottom: 5px;'><a class='black-text' href='https://github.com/nrvpatel03/beer-peers' target='_blank'>GitHub</a></p></div></div>");
        var projcard2 = $("<div class='col s12 m6 l4'><div class='card medium'><div class='card-image'><img src='assets/images/cookieFinderPic.JPG'><span style='font-size:1.40em;' class='card-title white-text red'>Cookie Finder App</span></div><div class='card-content'><p class='card-textcontent'>A web application storefront able to find the nearest cookie vendors using the Google Maps API. </p></div><a style='font-size:1.40em;padding:10px;' class='red-text' href='https://cookie-seller-app.herokuapp.com/' target='_blank'>View Project</a><p style='font-size:1.40em;margin-top: 15px; margin-bottom: 5px;'><a class='black-text' href='https://github.com/nrvpatel03/Cookie_Finder' target='_blank'>GitHub</a></p></div></div>");
        ...
        var projcard4 = $("<div class='col s12 m6 l4'><div class='card medium'><div class='card-image'><img src='assets/images/gifwebpagethumbnail.jpg'><span style='font-size:1.40em;' class='card-title white-text red'>Giftastic Web App</span></div><div class='card-content'><p class='card-textcontent'>A web page using the GIPHY API to generate button categories which then generate gifs</p></div><a style='font-size:1.40em;padding:10px;' class='red-text' href='https://nrvpatel03.github.io/Giftastic-webpage/' target='_blank'>View Project</a><p style='font-size:1.40em;margin-top: 15px; margin-bottom: 5px;'><a class='black-text' href='https://github.com/nrvpatel03/Giftastic-webpage' target='_blank'>GitHub</a></p></div></div>");
        var projcard5 = $("<div class='col s12 m6 l4'><div class='card medium'><div class='card-image'><img src='assets/images/triviaquestiongamethumbnail.jpg'><span style='font-size:1.40em;' class='card-title white-text red'>Trivia Question Game</span></div><div class='card-content'><p class='card-textcontent'>A timed true and false trivia question game created using JavaScript timeout functions and CSS for design</p></div><a style='font-size:1.40em;padding:10px;' class='red-text' href='https://nrvpatel03.github.io/trivia-question-game/' target='_blank'>View Project</a><p style='font-size:1.40em;margin-top: 15px; margin-bottom: 5px;'><a class='black-text' href='https://github.com/nrvpatel03/trivia-question-game' target='_blank'>GitHub</a></p></div></div>");
